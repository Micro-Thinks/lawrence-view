...
const page = () => {
  return (
    <div>
      ...
      <h1 className=' text-3xl font-semibold tracking-widest flex items-center justify-center '>Rooms & Rates</h1>
        <p className=' flex items-center justify-center text-center text-black text-sm'>Explore our range of comfortable rooms, each thoughtfully designed for relaxation and convenience. From cozy single rooms to spacious suites, all accommodations feature modern amenities, plush bedding, and beautiful views. Select the perfect room to suit your style and budget, ensuring a memorable stay. Book now to enjoy luxury and comfort at exceptional rates.</p>
        </div>
  ...
  />
      ...
      <div className="grid grid-cols-3 grid-rows-2 gap-10">
        {room.icons.map((iconSrc, i) => (
          ...
          <Image height={20} width={20} key={i} src={iconSrc.src} alt="Room feature" className="h-full w-auto" />
  ...
  <Icon icon="icon-park:arrow-right" className="mt-1 text-[#C4A053] " />
  </div>
</div>
    </div>
  ))}
